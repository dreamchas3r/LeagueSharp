...
namespace Ezreal
{
	internal class Program
	{
		...
		private static void OnGameUpdate(EventArgs args)
		{
			...
			{
				Player.SetSkin(model: Player.BaseSkinName, id: Config.Item("SkinChangerTogggle").GetValue<bool>() ? Config.Item("SkinChangerID").GetValue<StringList>().SelectedIndex : Player.BaseSkinId);
			}
		...
		private static void SetMenu()
		{
			...
			foreach (var enemyChampion in ObjectManager.Get<Obj_AI_Hero>().Where(enemy => enemy.Team != ObjectManager.Player.Team))
			{
